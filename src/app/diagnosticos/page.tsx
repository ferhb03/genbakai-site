        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-slate-200 p-8">
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              Evaluación práctica para revisar el nivel actual de implementación
              de 5S y obtener una primera lectura del estado de orden,
          ...
          <div className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-8">
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              Este espacio crecerá con nuevas herramientas para evaluar
              estabilidad operativa, estandarización, liderazgo y madurez de
              mejora continua.
            </p>
          </div>
        </div>
